		...
		<div class="menu-header">
			...
			<div class="custom-nav" role="navigation">
						...
						<div class="nx-dropdown">
							<div class="sub-menu-section">
								<div class="container">
									<div class="col-md-12">
										<div class="sub-menu-center-block">
											@foreach($serviceWithSubservice as $service)
											<div class="sub-menu-column">
												<div class="menuheading">{{$service['service_name']}}</div>
												<ul>
				...
				<ul class="nav-list right-end-btn">
					...
					<li class="hidemobile"><a data-bs-toggle="offcanvas" href="#offcanvasExample" class="btn-br bg-btn3 btshad-b2 lnk">Request A Quote <i class="fas fa-phone-alt"></i><span class="circle"></span></a> </li>
		...
		<nav id="main-nav">
			<ul class="first-nav">
				...
				<li>
					...
					<ul>
						@foreach($serviceWithSubservice as $service)
						<li class="text-bold">{{$service['service_name']}}</li>
						@foreach($service['get_subservices'] as $subrow)
						<li><a href="#">{{$subrow['subservice_name']}}</a> </li>
						@endforeach
						@endforeach
			...
			<ul class="bottom-nav">
				...
				<li class="prb">
					<a href="https://separateweb.com/cdn-cgi/l/email-protection#0f7c60626a786a6d626a6b666e4f68626e6663216c6062">
